...
const QuitarEtiqueta = express()
const Consultador = require("../../../../database/Consultador")
const SecureVerify = require("../../../lib/Funciones/SecureVerify")

QuitarEtiqueta.post('/test/quitarEtiqueta', async (req, res) => {
    ...
    const sql2 = ` DELETE FROM produscts_tags WHERE id_prod = ? AND tag = ? `
    let sql1
    let result1
    let result2
    let valores1
